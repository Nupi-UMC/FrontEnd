...
class WhatToPlayCollectionViewCell: UICollectionViewCell {
    ...
    // MARK:
    //버튼
    let whatToPlayButton = UIButton().then {
    ...
    //장소 이름
    let whatToPlayLabel = UILabel().then{
        $0.text = "izakaya"
    ...
    private func setupView(){
        addSubview(whatToPlayButton)
        addSubview(whatToPlayLabel)
        
        whatToPlayButton.snp.makeConstraints{
        ...
        whatToPlayLabel.snp.makeConstraints{
